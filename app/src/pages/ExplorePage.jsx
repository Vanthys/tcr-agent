...
import { Layout, Select, AutoComplete, Badge, Tooltip, Spin, Button, Segmented, Input, message, Slider, Popconfirm } from 'antd'
    ...
    <Layout style={{ height: '100vh', overflow: 'hidden' }}>
      ...
      <Header style={{
        ...
        <Popconfirm
          ...
          onConfirm={triggerUmapRecompute}
            ...
            <div style={{
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                ...
                <Slider
                  ...
                  onChangeComplete={v => { setXDim(v); setYDim(v + 1); }}
